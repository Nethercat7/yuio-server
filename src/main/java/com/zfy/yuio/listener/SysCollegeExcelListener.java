...
public class SysCollegeExcelListener extends AnalysisEventListener<ExcelCollege> {
    /**
     * 每隔5条存储数据库，实际使用中可以3000条，然后清理list ，方便内存回收
     */
    private static final int BATCH_COUNT = 5;
    List<ExcelCollege> list = new ArrayList<ExcelCollege>();
    ...
    @Override
    public void invoke(ExcelCollege data, AnalysisContext analysisContext) {
        list.add(data);
